---
name: ink-core
description: Ink Core - React for CLIs. Build interactive command-line applications with React components, flexbox terminal layouts, keyboard input handling, hooks, and rendering controls.
---

# Ink Core Skill

Ink (React for CLIs) - Build interactive command-line applications with React components, flexbox terminal layouts, keyboard input handling, hooks, and rendering controls.
...
- **other.md** - Core documentation (components, hooks, rendering, styling)
...
- This skill was generated from Ink Core documentation
